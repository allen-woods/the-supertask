  ...
  try {
    ...
    switch (typeString) {
      ...
      case 'num':
        ...
        break
      case 'arr':
        returnValue = dataObj && typeof dataObj === 'object' && dataObj.constructor === Array
        break
      case 'fun':
        returnValue = typeof dataObj === 'function'
        break
      case 'obj':
        returnValue = dataObj && typeof dataObj === 'object' && dataObj.constructor === Object
        break
      case 'nul':
      ...
      case 'boo':
        ...
        break
      case 'reg':
        returnValue = dataObj && typeof dataObj === 'object' && dataObj.constructor === RegExp
        break
      case 'err':
        returnValue = dataObj instanceof Error && typeof dataObj.message !== 'undefined'
        break
      case 'dat':
